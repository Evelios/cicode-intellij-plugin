 ...
 */
final class CicodeDocumentationProvider extends AbstractDocumentationProvider {

  /**
   * For the Cicode Language, we don't have online documentation. However, if your language provides
  ...
  /**
   * Extracts the key, value, file and documentation comment of a Cicode key/value entry and returns
   * a formatted representation of the information.
   */
  @Override
  public @Nullable String generateDoc(PsiElement element, @Nullable PsiElement originalElement) {
    if (element instanceof CicodeProperty) {
      final String key = ((CicodeProperty) element).getKey();
      final String value = ((CicodeProperty) element).getValue();
      final String file = SymbolPresentationUtil.getFilePathPresentation(element.getContainingFile());
      final String docComment = CicodeUtil.findDocumentationComment((CicodeProperty) element);
  ...
  /**
   * Provides the information in which file the Cicode language key/value is defined.
   */
  @Override
  ...
  /**
   * Provides documentation when a Cicode Language element is hovered with the mouse.
   */
  @Override
